...
| ID | 役 | 表示名 | カード |
|---|---|---|---|
| `913a8b14-a575-41ba-b0ad-c68a2dfb5b47` | **A 投稿** | サクラ専属自動投稿 | `bots/A-サクラ専属自動投稿.md` |
| `4efdf8ca-6648-46c7-9843-e1f4febe4325` | **B Imagine** | サクラImagine | `bots/B-サクラImagine.md` |

A は 2026-09-15 に実機で確認（表示名「サクラ専属自動投稿」、ルーチン 05:00 起動キー / 06:00 投稿ゲート）。B は残りの1体。カードの中身は入れ替えない。
