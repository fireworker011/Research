...
SITUATION_HELP = {
    ...
    "sales-visit-60s": "訪問販売。対面20秒。8本＝85秒。9:16。玄関。口はアヤ22ミニ・竿なし。販売員は5人目25・短め黒髪・中乳・ふたなり20cm・金玉なし・竿の根元にマンコ。跪き済みでハヤク。おミズ＝放尿を飲み干してからジュボ15秒。口内は粘る白液を残して見せる。セリフ: こんにちは。おミズをおトドケにきました／オソいわよ／ハヤクおミズちょうだい／あー、シミる／ありがとうございました。行為は無言・寄り。hmmotion なし。",
