...
受け入れる＝接合のまま出口・完了。誘う＝各シーンのあと次へ、最後だけ淫欲・失敗。回避＝一人で出口・完了。戦って勝つ＝倒して出口・完了。戦って負ける＝敗北H・失敗。
6 番は誘うポーズ。7 番は道中トイレ（どれでも次へ）。登場チェックを外すとその人を飛ばす。
...
3. 5 番で構成を選ぶ。迷ったら ○受け入れる。6・7・登場は病棟の追加。霞東では無視される。
