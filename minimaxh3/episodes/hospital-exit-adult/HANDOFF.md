...
- `04-gin-ride`: あやは `04-gin-jupo` の最後の姿勢のまま一切動かない。両手のひら・両かかとは同じ位置、腕はまっすぐ、頭は右。ギンは STANDS UP、STEPS RIGHT であやの腰の上、あやの方を向く。手前の膝は高く上がる。もう一方の足裏はあやの腰の横のリノリウム。ギンの両手はあやの両胸、片手ずつ。膝も竿も持たない。一度だけ腰をまっすぐ下ろす。根元まで入り尻があやの腰に当たったら止める。腰は静止、上下しない。両手は両胸に残る
- `04-gin-peak`: あやは同じ姿勢のまま（両手を後ろ、頭は右、かかとは同じ位置）。ギンは入ったまま、片膝は上がったまま、もう一方の足裏は床。両手はあやの両胸に置いたまま。短い上下。亀頭は中に残る。中出しの文は書かない
...
`04-gin-ride` と `04-gin-peak` で、あやは口の最後の姿勢（両腕を後ろについて上体を倒す、頭は右）から動かない。両拍とも同じ姿勢の文を入れる。ギンは STANDS UP、STEPS RIGHT、片膝は上がり、もう一方の足裏は床。両手はあやの両胸、片手ずつ。一度だけ腰を下ろして根元で止める。`04-gin-peak` は入ったまま同じ脚の形で、両手を両胸に置いたまま短い上下。亀頭は中。中出しの文は書かない。しゃがむ語、両足を同じ側、上下と停止の同時指示は書かない。04 の歩きは出口ではない。オプションを全部入れてもギンの次は `04-tsuno-meet-spot`。角の次の拍は `04-dog-spot`。犬の LoRA はページ URL しか無く、保存された HTML を重みとして読むと Comfy がそこで落ち、角の動画のあと生成が止まる。HTML は消して、その拍は LoRA なしで続ける。ミッション完了は最後の拍だけ。誘うでは最後も完了にしない。

## 騎乗のカメラ

横からの距離固定。全身、両足。同じ大きさ。着座は短い順。参照の寝姿と左右が逆。竿役が完全に仰向け、頭は右、足先は左、頭と肩が床。竿は股間のあいだに根があり、亀頭が上端、真上のまま。あやの頭は左。あやは股間の上で一度しゃがみ、腰をまっすぐ下ろす。片腿は竿役の手が抱えて上げる。もう一方の足は股間の横のリノリウムに着く。亀頭はマンコの真下から真上へ入り、根元まで入ったら止める。このカットは上下しない。腰は静止。次の絶頂だけ、入ったまま縦に短い上下。着座も絶頂も、画面の二人はあやと相手だけ。挿入の瞬間、立っていた竿役が床の顔になる。跪いていたあやが上の顔になる。`nothing new enters` は書かない。ギンの騎乗はこの構図にしない。
