...
- `04-gin-ride`: 短い順。あや（竿役）が頭を床につけて仰向け。頭は右、足先は左。24cm は股間のあいだに根があり、亀頭が上端、真上のまま。ギンは同じ向きのまま一度立つ。足は腰の両脇、竿を挟んで一本ずつ。マンコは亀頭の真上。そこから縦線を真下に下ろすと竿が入る。両手はあやの胸。尻があやの腰に当たるまで落とす。立ち、足、スクワット、挿入まで同じ向き。そこで挿入完了、そのカットは止める
...
- `zai1`: 竿役が床に尻をつく。先は真上。あやが腰を垂直に下ろして根元まで入れ、そこで止める。太ももと尻が付き、竿は見えなくなる。あやの両足は相手の足の手前から背中へ回り、足首が背中の後ろでクロス。口は付いたまま。このカットでは腰を上下しない
...
`04-gin-ride` は銀髪が LEFT、黒髪があやで RIGHT。Gin STANDS UP のあと STEPS RIGHT。足裏は膝の両脇に一本ずつ。握って先を当て、LOWERS her hips straight down で根元まで。そこで止める。`04-gin-peak` は入ったまま、両手を胸に置いて短い上下。しゃがむ語、両足を同じ側、上下と停止の同時指示は書かない。04 の歩きは出口ではない。ミッション完了は最後の拍だけ。
