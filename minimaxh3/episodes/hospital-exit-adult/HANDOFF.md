...
- 次: 竿役が両膝を抱えて持ち上げ、膝は開く。あやの腕は相手の背中。挿入中はべろちゅー。キス LoRA 0.5。涎が口を覆い、顎から垂れ、舌は口元を舐める。体位名は書かない
- 次: 入ったまま中出し。二人とも快楽の絶頂顔。口は付いたまま。涎は垂れたまま
...
- みきの `03-kiss-zai1`: あやは LEFT で跪き、唇が勃起した 24cm にある。ミキは RIGHT で立っている。口が竿を離す。ミキはその RIGHT のリノリウムに座る。胴は直立、膝は曲がり、両足は床。24cm は股間から上。あやは跪きから立ち、ミキへ寄って向かい合って座る。脚はミキの腰、あやの腕は肩、ミキの腕はあやの腰。胸が密着。あやが腰を下ろし、24cm がマンコの根元まで入って腰が密着したら静止。このカットでは腰を上下しない
