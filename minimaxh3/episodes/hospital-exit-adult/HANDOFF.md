...
- `04-gin-ride`: あやは `04-gin-jupo` の最後の姿勢のまま一切動かない。両手のひら・両かかとは同じ位置、腕はまっすぐ、頭は右。ギンは STANDS UP、STEPS RIGHT であやの腰の上、あやの方を向く。手前の膝を高く上げ、自分の手でその膝を抱える。もう一方の足裏はあやの腰の横のリノリウム。空いた手で 24cm を持ち亀頭をマンコに当て、一度だけ腰をまっすぐ下ろす。根元まで入り尻があやの腰に当たったら止める。腰は静止、上下しない。空いた手は竿から離れる
- `04-gin-peak`: あやは同じ姿勢のまま（両手を後ろ、頭は右、かかとは同じ位置）。ギンは入ったまま、片手で上げた膝を抱え、もう一方の足裏は床、空いた手はあやの胸。短い上下。亀頭は中に残る。中出しの文は書かない
