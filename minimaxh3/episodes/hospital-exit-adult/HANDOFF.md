...
- `04-gin-ride`: 短い順。あや（竿役）が頭を床につけて仰向け。頭は右、足先は左。24cm は股間のあいだに根があり、亀頭が上端、真上のまま。ギンは同じ向きのまま一度立つ。足を竿の位置へ。スクワットで腰を下ろす。両手はあやの胸。亀頭がマンコに触れてから中へ。尻があやの腰に当たるまで落とす。立ち、足、スクワット、挿入まで同じ向き。そこで挿入完了、そのカットは止める
...
横からの距離固定。全身、両足。同じ大きさ。着座は短い順。竿役が完全に仰向け、頭は右、足先は左、頭と肩が床。竿は股間のあいだに根があり、亀頭が上端、真上のまま、その股間から動かない。受け入れ側の頭は左。同じ向きのまま一度立つ。足は同じ床の上で、その股間の横へ揃える。右方向へ滑らせない。スクワットで腰を下ろす。両手は竿役の胸。亀頭がマンコに触れてから中へ入り、尻が竿役の腰に当たるまで落とす。立ち、足、スクワット、挿入まで同じ向き。そこで挿入完了。そのカットは止める。上下は次の絶頂。絶頂も頭は右と左のまま、竿は股間から真上。体位名は書かない。途中で止める3段は書かない。
