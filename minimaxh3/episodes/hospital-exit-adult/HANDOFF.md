...
- `04-gin-ride`: 挿入前にギン（竿なし）が頭を床につけて仰向け。後頭部と肩がリノリウム。竿は外。それからあやがまたがって入れる。`SQUATS from above` は書かない
...
横からの距離固定。あやの顔と相手の顔が残る。全身、両足。着座は、竿を持たない側が挿入前に頭を床につけて仰向けになる。後頭部と肩がリノリウム。竿は外。それから竿を持つ側がまたがって、3段で中へ。`SQUATS from above` と足を滑らせる文は書かない。
...
口の最終コマは跪き、唇が根元。次の着座は、あや（竿なし）が頭を床につけて仰向けになってから、かながまたがって入れる。3段。口カットの途中で着座へ変形しない。かなを仰向けにしない。
