...
- `04-gin-ride`: 挿入前にあや（竿役）が頭を床につけて仰向け。後頭部と肩がリノリウム。頭は右、足先は左。24cm は股間から垂直に真上。それからギンが `SQUATS from above` で上から3段で入れる。受け入れ側のまたがりは変えない
- 騎乗の絶頂は、竿役があやのまま仰向け、後頭部は床。短い上向きの突き。ギンは上に座ったまま腰を下ろす。腰は密着に戻り、根元から漏れる。画面はあや一人とギン一人。あやを増やさない
...
横からの距離固定。あやの顔と相手の顔が残る。全身、両足。着座は、竿役が挿入前に頭を床につけて仰向けになる。後頭部と肩がリノリウム。竿は股間から垂直に真上。それから受け入れ側がこれまで通りまたがって、3段で中へ。誘う騎乗は足を滑らせて位置を合わせる。ギンの `04-gin-ride` だけ `SQUATS from above`。
...
口の最終コマは跪き、唇が根元。次の着座は、かな（竿役）を仰向けにして頭を床につけてから、あやが足を滑らせて3段で入れる。口カットの途中で着座へ変形しない。あやを仰向けにしない。
