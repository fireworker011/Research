...
- `zai1`: 竿役がその場で床に座る。あやが腰を下ろして竿を根元まで入れる。それから腰を上下する。口は付いたまま。舌を絡め、口の周りも舐める。両手はお互いの背中。体は密着
- `zai2`: 入ったまま、べろちゅーのまま腰を上下する
...
`04-gin-ride` は、視聴者から見てあやの膝のすぐ右の床に足裏を接して立つ。そこから腰を下ろして竿をマンコに収める。両手はあやの胸。`04-gin-peak` もその足の位置のまま。
