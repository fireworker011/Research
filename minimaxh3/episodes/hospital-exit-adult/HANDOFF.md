...
- `04-gin-ride`: 短い順。あや（竿役）が頭を床につけて仰向け。頭は右、足先は左。24cm は真上。ギンは同じ向きのまま一度立つ。足を竿の位置へ。スクワットで腰を下ろす。両手はあやの胸。亀頭がマンコに触れてから中へ。尻があやの腰に当たるまで落とす。そこで挿入完了、そのカットは止める
...
横からの距離固定。全身、両足。着座は短い順。竿役が完全に仰向け、頭と肩が床、竿は真上。受け入れ側は同じ向きのまま一度立つ。足を竿の位置へ動かす。スクワットで腰を下ろす。両手は竿役の胸。亀頭がマンコに触れてから中へ入り、尻が竿役の腰に当たるまで落とす。そこで挿入完了。そのカットは止める。上下は次の絶頂。体位名は書かない。途中で止める3段は書かない。
...
小便は、座りが正面の M 字になってから。あやは笑顔のまま、腰は止めたまま、便器も止めたまま。マンコから黄色い液体をカメラの正面へ飛ばす。動くのは黄色い流れだけ。便器の中へ流す文は書かない。否定の「動かない」は書かない。
