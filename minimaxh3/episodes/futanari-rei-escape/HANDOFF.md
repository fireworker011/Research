...
蛾スロット: 蜘蛛女。上半身はレイと同じ背丈の裸体の女性。下半身は節腹、多脚、尾。尾の先端の円口。森は出さない。場所は古城。
...
トイレは食虫植物の着座形。緑の外皮、内側は湿った赤、蜜色の液。陶器は出さない。脱糞は書かない。トイレのあと肌に糞を塗らない（`DIRTY-STATE` は今の生成では付かない）。フォームの「肉壁の触手」ラベルはまだ未変更。
