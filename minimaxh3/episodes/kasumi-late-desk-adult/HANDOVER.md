...
| 人 | 歳 | |
|---|---|---|
| みお | 21 | スレンダー Aカップ。くびれ。黒髪肩まで。竿なし。トートなし |
| なな | 23 | スレンダー Bカップ。くびれ。茶髪ボブ。ふたなり 24cm。机でシコシコ |
| 青木 | 27 | スレンダー Cカップ。くびれ。茶髪ロングパーマ。ふたなり 24cm。オフは後背位。オンは倒してじゅぼ |
| 黒木 | 29 | スレンダー Dカップ。くびれ。黒髪ポニテ。メガネなし。ふたなり 24cm。オフはベロチュー押し倒し＋挿入開始。オンは敗北ピン |

本線は Colab 4 番で分かれる。オフ=じゅぼ口内口移し・後背位中出し・挿入開始から仰向け正常位（戦いなし）。オン=横スク戦い＋じゅぼ＋正常位ピン。混ぜない。

同枝に別スラッグ `hospital-exit-adult`（ボロボロ病棟脱出。話で選ぶ。Colab 5 番が全体の既定。シーンごとで誘う・受け入れる・回避。みき 24cm ふたなり・れい 24cm・かな 20cm 3番目・しの 30cm 4番目・妖艶＋長い舌。登場スキップ・誘うポーズ・道中トイレあり）。
