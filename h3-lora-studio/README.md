...
| ケンシン | `clinic-75s` | 10本＝100秒。台詞10秒、キス/ジュボ/騎乗は無言10 | 医院にアヤが来る。医師が20cm。パイプ椅子。1本目は左手シコシコ無表情、右入場、「おっきい」のあと短い立ちキス、右のパイプ椅子におすわり（女医は立つ）。10-20は問診。20-30はみていきますねと妖艶に立ち上がり、胸を触りながらディープキス。終わりは口を開けて先端から手の幅。しゃがみジュボ（マンコこすり）→押し倒し（仰向けで妖艶に微笑む）騎乗挿入→中出し抜く→お掃除→仰向け口移し→ゲンキ | カナ、1本2行まで |
