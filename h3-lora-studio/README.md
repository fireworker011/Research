...
| ケンシン | `clinic-75s` | 9本＝90秒。16:9。こんにちは→椅子座りジュボ（顔残し）→起立ベロチュー→対面立ちごめん／ダイジョウブ→30度四つん這い接触→挿入→パコ→中出し | 医院にアヤが来る。医師が20cm。アヤ受け。レイなし。騎乗なし。女医は仰向けにしない。0-10 こんにちは→pipe chair に SEATED しゃがみジュボ（医師の顔はフレームに残る。PULLED BACK）。10-20 ジュボやめ+涎+起立ベロチュー。20-30 ベロチュー抱擁コシコシ。30-40 ごめんなさい／ダイジョウブですよー（対面立ち。床に手をつかない。背を向けない）。40-50 向き転換→両手床→両膝→尻を開く→医師が後ろに膝→先端が outer ring of the anus entrance に接触（未挿入）。50-60 同じ姿勢のままその輪から根元まで挿入。60-70 パコパコ。70-80 アナル中出し→抜いて垂れ。80-90 ゲンキになりましたか／はい、スッキリしました。c5-c8は 30 degrees・SAME DIRECTION・NO KISS。rim / 縁 禁止 | カナ、1本2行まで |
