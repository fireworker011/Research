...
| パック | id | 本数 | 建前 / 型 | 台詞 |
|---|---|---|---|---|
| 訪問販売 | `sales-visit-60s` | 対面20秒。カチカチのあと扱きながらベロチュー。キスをやめてあつい／サービス。いっただきまーすで跪き、口を開けて咥える準備からジュボ。8本＝80秒 | 玄関のミルク売り。頭に帽子。手は空。1本目は左手に販売員が一人、チャイム、右からアヤ。ハンバイのあと扱き→口内。竿舐め禁止 | カナ、1本2行まで |
