...
| ケンシン | `clinic-75s` | 9本＝90秒。16:9。こんにちは→即しゃがみジュボ→起立ベロチュー→四つん這い接触→挿入→パコ→中出し | 医院にアヤが来る。医師が20cm。アヤ受け。レイなし。騎乗なし。女医は仰向けにしない。0-10 こんにちは→即しゃがみジュボ。10-20 ジュボやめ+涎+起立ベロチュー。20-30 ベロチュー抱擁コシコシ。30-40 ごめんなさい／ダイジョウブですよー。40-50 四つん這い・先端が肛門に接触（未挿入）。50-60 挿入オンカメラ。60-70 パコパコ。70-80 アナル中出し→抜いて垂れ。80-90 ゲンキになりましたか／はい、スッキリしました | カナ、1本2行まで |
