...
全物語はこの3つのどれかで終わる。混ぜない。

1. **口内で終わる**（従来）: じゅぼフェラ→口内射精（`oral` → `oral_creampie`）。そのあとだけ口移しが付く。終点・カラオケ・赤信号・講義机・ガソスタ・トンネル電話・ハチコウ・ザーメン風呂
2. **フェラのあとアナル**: じゅぼフェラで**射精せず抜き**（`Pulls OFF at the end. No ejaculation.`）→アナル挿入オンカメラ→アナル中出し（`oral` → `futa_anal`）。帰宅・洗い物・登校・授業・おかえり・風呂・食卓・布団・訪問販売・定期検診・ケンシン・終電のホーム・ニクカベ・肥溜め・カフェ・車内販売・背中流し・ヨガ・キャンプ
3. **会って即アナル**: 濃厚ベロチュー＋胸揉み＋チンチン／マンコシコシコ＋こすり（`NOT oral. NOT insertion.`）→そのままアナル挿入オンカメラ→アナル中出し（`futa_visible` → `futa_anal`）。ハイスイコウ・テトラ・ロッカー・ドウロ・展望台・川原・屋上クーラー・コウジョウ
...
| ランドリー | `laundromat-50s` | 10×5 | あと何分。洗濯機の上で対面座位アナル挿入→中出し（futa_anal） | カナ、2行まで |
...
| ガケの展望台 | `lookout-30s` | 10×2 | 物語の追加。霧の会話→ベロチュー＋胸揉み＋シコシコ→無言アナル挿入中出し | カナ、1本目2行 |
| コウジョウあと | `factory-30s` | 10×2 | 物語の追加。サビの会話→受け入れる立ち・アナル挿入寸前→無言で立ち後背アナル中出し | カナ、1本目2行 |
