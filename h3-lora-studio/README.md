...
| ふたなりフェラ | `futa_blowjob` | Blowjob 0.75 | Synth 0.55 | Larry 0.5 | なし | 穴の見え方。竿 LoRA は外す。女体ロック。性器と肛門 |
| セックス（女体） | `futa_sex` | AIO 0.8 | Penis 0.7 | Larry 0.5 | なし | 男・筋肉質の男体にしない。12step。挿入が見える |
