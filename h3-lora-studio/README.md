...
| ケンシン | `clinic-75s` | 6本＝75秒。台詞10秒、キス15・ジュボ15・口内15無言 | 医院にアヤが来る。医師が20cm。1本目は左手シコシコ無表情、右入場、「おっきい」の直後に短いキス、右の椅子におすわり。ウンチ相談→おクチキス（身を胸につける。胸は揉まない）→ジュボ尻餅→口内口移し→ゲンキ | カナ、1本2行まで |
...
| ニクカベ | `meat-wall-85s` | 7本＝85秒。歩行15、台詞10、ジュボ15・口内15無言 | 巨大生物の体内。コンクリートに肉を貼った部屋ではない。歩行の床は弾力（足は沈まない）。茶色い粘液＋白いおフロ（生体の窪み）。顔は液面より上。全部飲む。口移しなし。家のザーメン風呂とは別 | カナ、1本2行まで |
