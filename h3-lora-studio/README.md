...
| **②フェラのあとアナル** | 汎用40秒。ジュボで射精せず抜き→アナル挿入オンカメラ→アナル中出し | アナル本に効く（既定は立ち後背） |
| **③会って即アナル** | 汎用40秒。短いベロチュー→10-20でアナル挿入オンカメラ（まだ出さない）→20-30アナル中出し | アナル本に効く |
...
2. **フェラのあとアナル**: じゅぼフェラで**射精せず抜き**（`Pulls OFF at the end. No ejaculation.`）→アナル挿入オンカメラ→アナル中出し（`oral` → `futa_anal`）。帰宅・洗い物・登校・授業・おかえり・風呂・食卓・布団・山小屋・訪問販売・定期検診・ケンシン・終電のホーム・ニクカベ・肥溜め・カフェ・車内販売・背中流し。キャンプだけフェラの代わりにクンニ（`cunnilingus_futa` → `futa_anal`）
3. **会って即アナル**: 短いベロチューのあとすぐ受け入れる姿勢（`NOT oral. NOT insertion.`）→10-20でアナル挿入オンカメラ（まだ出さない）→20-30アナル中出し（`futa_visible` → `futa_anal` ×2）。屋上・休日・縁側・ヨガ・コインランドリー・花火・ハイスイコウ・テトラ・ロッカー・ドウロ・展望台・川原・屋上クーラー・コウジョウ
...
体位は場面ごとに一番再現しやすいものを当てる（正常位・後背位・立ち後背位・騎乗位・後輩騎乗位・座位・後背位座位）。結合部が見える後背位／立ち後背位を多めにするが、座り物や仰向けの場面に捩じ込まない。前の本の終わりが必ず**受け入れる姿勢＋穴から手の幅・未挿入**で終わり、次の本が `INSERTION ON CAMERA` から始まる。
