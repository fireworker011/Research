...
| ハイスイコウ | `manhole-30s` | 15×2 | 物語の追加。フタの会話→口を開けて先端から手の幅→無言ジュボ口内。口移し | カナ、1本目2行 |
| 屋上クーラー | `roof-ac-30s` | 15×2 | 物語の追加。会話→受け入れる立ち・挿入寸前→無言でもう入っている立ち（hmmotion） | カナ、1本目2行 |
| ハマのテトラ | `tetrapod-30s` | 15×2 | 物語の追加。風の会話→跪いて口を開けて先端から手の幅→無言ジュボ口内。口移し | カナ、1本目2行 |
| 廃校ロッカー | `locker-30s` | 15×2 | 物語の追加。カギの会話＋キス→跪いて口を開けて先端から手の幅→無言ジュボ口内。口移し | カナ、1本目2行 |
| ドウロのど真ん中 | `crossing-30s` | 15×2 | 物語の追加。信号の会話→跪いて口を開けて先端から手の幅→無言ジュボ口内。口移し | カナ、1本目2行 |
...
| ガソリンスタンド跡 | `gas-station-30s` | 15×2 | 物語の追加。ミズ＝放尿を飲んで口を開けて先端から手の幅→無言ジュボ口内。口移し | カナ、1本目2行 |
| トンネル非常電話 | `tunnel-phone-30s` | 15×2 | 物語の追加。電話の会話→受話器持ったまま跪いて口を開けて先端から手の幅→口だけ。口移し | カナ、1本目2行 |
| 川原のゴミ | `riverbank-30s` | 15×2 | 物語の追加。フクロの会話→跪いて口を開けて先端から手の幅→無言ジュボ口内。口移し | カナ、1本目2行 |
