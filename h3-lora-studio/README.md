...
| 定期検診 | `checkup-100s` | 対面30秒。キス10＋ジュボ10。9本＝90秒 | 家の玄関。1本目は左手に医師が一人、チャイム＋こんにちは、右からレイがはい。かたくておっきいで軽くチンチンにキス→シツレイして、いっぱいさわっちゃいますね→キスと胸→ぬるぬるでモンダイない→カチカチおくまでカクニン→ジュボは射精せず抜いて正常位アナル中出し。「ふふ、モンダイありすぎ。アナルにだされすぎ、、、」 | カナ、1本2行まで |
| ケンシン | `clinic-75s` | 10本＝100秒。台詞10秒、キス/ジュボは無言10 | 医院にアヤが来る。医師が20cm。パイプ椅子。1本目は左手シコシコ無表情、右入場、「おっきい」のあと短い立ちキス、右のパイプ椅子におすわり（女医は立つ）。10-20は問診。20-30はみていきますねと妖艶に立ち上がり、胸を触りながらディープキス。終わりは口を開けて先端から手の幅。しゃがみジュボ（マンコこすり）→押し倒し（仰向けで超気持ちよさそう）ジュボしまくる→射精せず抜いて仰向けの上に跨りアナル中出し→あとしまつ→ゲンキ | カナ、1本2行まで |
