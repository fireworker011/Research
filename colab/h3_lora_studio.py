...
SITUATION_HELP = {
    ...
    "anal_closeup": "アナル舐め・指（女体）。穴の見え方 0.7 + Larry 0.5 + シネマ 0.4。女同士。男なし。",
    ...
    "after_ejaculation": "後射精（女体）。射精 LoRA 0.9 + 竿 0.7 + Larry 0.5 / 8step。ふたなり。男なし。絶頂・顔射とは別。",
    "facial": "顔射（女体）。顔射 LoRA 0.8 + 竿 0.7 + Larry 0.5 / 8step。ふたなり＋女。男なし。後射精・絶頂とは別。写真からが本線。",
    "fingering": "指入れ。女1人。指 LoRA 0.85 + 穴の見え方 0.55 + Larry 0.5 / 8step。男なし。",
