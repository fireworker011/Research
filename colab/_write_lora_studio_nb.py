...
DEFAULT_PLAY_JA = STORY_PLAY_JA[STORY_PLAY_CHAIN]
...
| 肛門から今出す脱糞 | 脱糞（どの構図） | しゃがみ／立ち／後背など | 写真から。場所は文章欄。肥溜めの塗れとは別 |
...
| ①口内で終わる | 汎用40秒。会話→根元ジュボ→口内 CUMOUF→口移し。**既存話は差し替えない** | フェラ + CUMOUF + 竿 + 穴。体位欄は無視 |
| ②フェラのあとアナル | 汎用40秒。ジュボで射精せず抜き→アナル挿入→アナル中出し。**既存話は差し替えない** | フェラ + 竿 + 穴。体位欄がアナル本に効く（既定は立ち後背） |
| ③会って即アナル | 汎用40秒。短いベロチュー→10-20でアナル挿入→20-30中出し。**既存話は差し替えない** | 竿 + 穴。ジュボなし。体位欄がアナル本に効く |
| 帰宅（専用 / つなぐ / つなぐ修） | 玄関ジュボは抜く。リビングでジュボのあと射精せず、後背位アナル中出し。10×12 | クンニ LoRA は寄り1本。入室・退出は歩行部品。口内 CUMOUF なし。576×1024 |
| 洗い物（専用 / つなぐ / つなぐ修） | シンク洗い物＋プリン。アヤは床でジュボのあと射精せず、後背位アナル中出し。10×12 | サヤカはシンク固定。レイは椅子で竿。口内 CUMOUF なし |
| 登校（専用 / つなぐ / つなぐ修） | 朝〜大学正門。玄関ジュボは抜く。路地でジュボのあと射精せず、立ち後背位アナル中出し。10秒×12本。16:9。**今はテキストから** | 1本1場所。セリフは口元3本。授業は授業。写真は任意 |
| 授業（専用 / つなぐ / つなぐ修） | 授業〜昼。ジュボのあと射精せず、個室で後背位アナル中出し。10秒×10本＝100秒。16:9 | 家とサヤカなし。机のシコはオナニー寄り。クンニは寄り1本。口内 CUMOUF なし。セックスの続きは屋上 |
| 屋上（専用 / つなぐ / つなぐ修） | 屋上で立ち後背位アナル中出し〜家の門。10秒×10本。16:9 | 1本1場所。セリフは口元2本。AIOなし・hmmotionなし。玄関はおかえり |
| おかえり（専用 / つなぐ / つなぐ修） | 家の門〜玄関ジュボのあと射精せず、立ち後背位アナル中出し。10秒×12本。16:9 | 屋上の続き。セリフは口元3本。口内 CUMOUF なし。夜風呂は風呂 |
| 風呂（専用 / つなぐ / つなぐ修） | 夜風呂。洗い場でジュボのあと射精せず、座位アナル中出し。10秒×12本。16:9 | セリフは口元3本。口内 CUMOUF なし。ご飯〜食卓は食卓 |
| 食卓（専用 / つなぐ / つなぐ修） | 風呂上がり〜食卓。テーブル下ジュボのあと射精せず、座位アナル中出し。10秒×12本。16:9 | セリフは口元3本。口内 CUMOUF なし。夜の布団は布団 |
| 布団（専用 / つなぐ / つなぐ修） | 食卓から布団。横になったままジュボのあと射精せず、正常位アナル中出し。10秒×12本。16:9 | セリフは口元2本。口内 CUMOUF なし。休日午前は休日 |
| 休日（専用 / つなぐ / つなぐ修） | 休日午前。ソファは後輩騎乗位アナル中出し（抜かない）→ハードカットで床ジュボ→口内＋口移し。10秒×12本。16:9 | セリフは口元2本。アナル本に騎乗LoRAなし。AIOなし。午後の縁側は縁側 |
| 縁側（専用 / つなぐ / つなぐ修） | 休日午後。後背位座位アナル中出し（抜かない）→ハードカットでアヤがマドカをジュボ→口内＋口移し。10秒×12本。16:9 | セリフは口元2本。竿役はマドカ。レイは入れない。アナル本に騎乗LoRAなし |
| 訪問販売（専用 / つなぐ / つなぐ修） | 玄関のミルク売り。帽子（ハット）のみ。販売員常時1人。こんにちは→アヤ不出→おじゃましまーす右へ。玄関仰向けM字アナニー。覆い被さりベロチュー→正常位膣挿入。パコ。膣中出し。抜きカエル。サービスおしっこ。8本＝80秒。16:9 | 名前付きパック。口内 CUMOUF なし。hmmotion なし。正常位LoRA having missionary sex は c3-c5 に 0.4 まで。顔が消えたら外す。旧名「訪問販売60秒（つなぐ）」＝つなぐ修 |
| 定期検診（専用 / つなぐ / つなぐ修） | 家の玄関。医師がレイを訪問。対面→キス→ジュボ→射精せず正常位アナル中出し。「アナルにだされすぎ」。9本＝90秒。16:9 | 名前付きパック。口内 CUMOUF と口移しなし。診察室ではない。台詞は話し言葉 |
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤ受け＋医師竿。こんにちは→椅子座りジュボ（顔残し）→10秒ずっとジュボ→口を外すご褒美小便→まみれベロチュー→30度四つん這い・先端が outer ring of the anus entrance に接触（未挿入）→同じ姿勢で根元まで挿入→パコパコ→アナル中出し→抜いて垂れ→ゲンキ。9本＝90秒。16:9 | 名前付きパック。騎乗なし。女医は仰向けにしない。口内 CUMOUF と口移しなし。レイなし。c5-c9は黄色い小便まみれを落とさない。c5-c8は SAME DIRECTION・NO KISS。rim / 縁 禁止 |
| 終点（専用 / つなぐ / つなぐ修） | 終点の車内。車掌が寝ているレイを起こす。10秒×4本。9:16 | 名前付きパック。声では起きない。ジュボで起きる。口内 CUMOUF のあと車掌に戻る（①のまま） |
| 終電（専用 / つなぐ / つなぐ修） | 終点の延長。ジュボ20秒→車内口内＋口移しで起こす→ホームでキス／立ちジュボ→射精せず立ち後背位アナル中出し→抱擁。10本＝100秒。9:16 | 名前付きパック。車内の口内だけ①のまま口移しあり。ホームの口移しなし。既存の終点はそのまま |
| ザーメン風呂（専用 / つなぐ / つなぐ修） | 家のおフロ。アヤが湯船、レイが20cmでドロドロの白い液体を溜める。5本＝50秒。9:16 | 名前付きパック。口移しなし。挿入なし。ジュボなし。三択の外 |
| ニクカベ（専用 / つなぐ / つなぐ修） | 巨大生物の体内。茶色い粘液で全身汚れ、白いおフロ。歩行はうわぁ＋手繋ぎ＋軽いキス。ジュボのあと射精せず立ち後背位アナル中出し。7本＝70秒。9:16 | 名前付きパック。口内 CUMOUF と口移しなし。家のザーメン風呂とは別 |
| ニクカベ肥溜め（専用 / つなぐ / つなぐ修） | 最初から塗れている肥溜め。頭から足先まで糞まみれ。キス→ジュボ→射精せず四つん這いアナル中出し。7本＝70秒。9:16 | 名前付きパック。**今出している脱糞ではない**（塗れ）。口内なし。素のニクカベとは別 |
| カフェ（専用 / つなぐ / つなぐ修） | 夏のカフェ。11本＝110秒。16:9。店員は常時1人。着席いきかえる→座位ジュボ→口内白→ごっくん→接地→挿入→パコ→アナル中出し→立ち上がる→おなかいっぱいベロチュー | 建前パック。二人目の店員・クローン・トレイ二つ禁止。口内 CUMOUF あり |
| 車内販売（専用 / つなぐ / つなぐ修） | 電車の車内販売。おチャ＝ジュボ、ミルクコーヒー＝ジュボのあと射精せず後背位座位アナル中出し。10秒×8本。9:16 | 建前パック。口内 CUMOUF なし。客レイの20cmは使わない |
| 赤信号（専用 / つなぐ / つなぐ修） | 信号待ちの車。運転レイ（両手はハンドル）、口アヤ。ジュボ→口内。放尿なし。10秒×5本。9:16 | 建前パック。車は動かない。①のまま |
| ヨガ（専用 / つなぐ / つなぐ修） | ヨガ教室。四つん這いアナル挿入オンカメラ→アナル中出し。10秒×5本。9:16 | 建前パック。後背位 LoRA なし。ジュボなし・放尿なし |
| 背中流し（専用 / つなぐ / つなぐ修） | 風呂場。背中→マンコ舐め→アガリユ＝ジュボのあと射精せず座位アナル中出し。10秒×6本。9:16 | 建前パック。クンニ LoRA。マドカの竿は舐めない |
| カラオケ（専用 / つなぐ / つなぐ修） | カラオケ。歌のあいだジュボ、最後の音で口内、点数。10秒×5本。9:16 | 建前パック。①のまま。放尿なし |
| ランドリー（専用 / つなぐ / つなぐ修） | 夜のコインランドリー。洗濯機の縁で座位アナル挿入オンカメラ→アナル中出し。あと何分。10秒×5本。9:16 | 建前パック。AIO なし。ジュボなし・放尿なし |
| 講義机（専用 / つなぐ / つなぐ修） | 大学の講義。アヤが教卓の下でジュボ→口内。上の声は授業。10秒×5本。9:16 | 建前パック。①のまま。授業（専用11話）とは別 |
| キャンプ（専用 / つなぐ / つなぐ修） | 夜のキャンプ。レイがアヤのマンコを舐めたあと、四つん這いアナル中出し。10秒×5本。9:16 | 建前パック。クンニ LoRA。ジュボなし。レイの20cmは舐め本では使わない |
| 花火（専用 / つなぐ / つなぐ修 / 参照つなぐ / 参照つなぐ修） | 川べりの花火。立ち後背位アナル挿入オンカメラ→アナル中出し。顔は花火。10秒×5本。9:16 | 建前パック。AIO なし。ジュボなし・放尿なし |
| 山小屋（専用 / つなぐ / つなぐ修） | 山小屋。糞まみれで扉の外のアヤ一人→便座でレイがシコシコ→ベロチュー→ジュボ→騎乗→後背→アナル中出し（マンコから出さない）。10秒×8本。9:16 | 建前パック。騎乗はマンコ。アナル本に騎乗LoRAなし |
...
| アナル舐め・指 | 舐め・指のアップ。動きの本線はアナル指入れ | 解剖 0.5 + 穴の見え方 0.5 + Larry 0.5。シネマなし |
| アナル指入れ | 自分の親指をアナルへ。指入れ（膣）とは別 | 解剖 0.5 + ThumbInButt 0.55 + 穴の見え方 0.4 + Larry 0.5 / 8step。写真からが本線 |
| フェラ（女体） | 女がふたなりにフェラ。竿＋根元のマンコが見える。男なし | 解剖 0.5 + フェラ 0.6 + 竿 0.45 + 穴の見え方 0.4 + Larry 0.5 / 8step |
| ふたなりフェラ | 汎用。空欄は第三者の2ショットで根元まで。場所・座りは文章。体位欄は無視。POVにしない | 解剖 0.5 + フェラ 0.55 + 竿 0.45 + 穴の見え方 0.4 + Larry 0.5 / 6step |
| セックス（女体） | ふたなり＋女。男なし。描写は文章欄 | 解剖 0.5 + 総合えっち 0.55 + 竿 0.45 + 穴の見え方 0.4 / 8step |
| アナルセックス（女体） | アナル本線。立ち・騎乗・後背・横は体位欄 | 解剖 0.5 + 竿 0.45 + 穴の見え方 0.4 / 8step。ThumbInButt なし。Turbo なし |
| 飲尿（どの構図） | 亀頭先から黄色い水を飲む。体位欄 | 解剖 0.5 + 竿 0.45 + 穴の見え方 0.4 / 8step。行為 LoRA なし。Turbo なし。既存話のジュボには戻さない |
| 放尿（性器から） | 黄色い水が性器（亀頭先の尿道口）から出る | 同じ積み。マンコや肛門から出さない |
| 脱糞（どの構図） | 今、肛門から出している動き。人間の糞（ソーセージ状の固形。ゼリーやスライムではない）。場所は文章欄。肥溜めの塗れとは別 | 解剖 0.5 + ThumbInButt 0.55 + 竿 0.45 + 穴 0.4 / 8step。積まないとマンコから出る。Turbo なし。医院・終電・既存物語には足さない |
| 騎乗位（女体） | 騎乗。総合えっちは積まない | 解剖 0.5。写真から: 騎乗POV 0.45。テキストから: cowgirl 0.55。竿 0.45 + 穴 0.4 / 8step。Turbo なし |
| 後背位（女体） | 後ろから前後の突き | 解剖 0.5 + 後背位 0.55 + 竿 0.45 + 穴の見え方 0.4 / 8step。Turbo なし |
| 正常位POV（女体） | 挿入側の視点。横からの正常位はセックス（女体） | 解剖 0.5 + POV挿入 0.55 + 竿 0.45 + Larry 0.5 / 8step |
| 後射精（女体） | 外に出す射精。中出し・顔射とは別 | 解剖 0.5 + 射精 0.55 + 竿 0.45 + Larry 0.5 / 8step |
| 顔射（女体） | 顔にかける。後射精・口内とは別 | 解剖 0.5 + 顔射 0.55 + 竿 0.45 + Larry 0.5 / 8step。写真からが本線 |
| 中出し（女体） | 膣の中に出す。後射精・顔射とは別 | 解剖 0.5 + Final Thrust 0.55 + 竿 0.45 + 穴の見え方 0.4 / 8step。Turbo なし。写真からが本線 |
| 口内射精（女体） | 口の中で出す。顔射・フェラ本線とは別 | 解剖 0.5 + CUMOUF 0.4 + 竿 0.45 + 穴の見え方 0.4 + Larry 0.5 / 8step。写真からが本線 |
| 指入れ | 膣への指の出し入れ。オナニー LoRA は積まない。アナルはアナル指入れ | 解剖 0.5 + 指 0.55 + 穴の見え方 0.4 + Larry 0.5 / 8step |
| オナニー | 潮吹き。指入れ LoRA は積まない | 解剖 0.5 + オナニー 0.55 + 穴の見え方 0.4 + Larry 0.5 / 8step |
| 足コキ | 両足で竿 | 解剖 0.5 + Type D 0.55 + 竿 0.45 + Larry 0.5 / 8step |
| 絶頂 | 女体の絶頂反応。射精ではない | 解剖 0.5 + 絶頂 0.55 + 穴の見え方 0.4 + Larry 0.5 / 8step |
| 汎用エロ（女体） | ふたなり＋女。男なし | 解剖 0.5 + AIO 0.55 + 竿 0.45 + 穴 0.4 / 8step |
| 試し打ち | エロの量産プレビュー | 解剖 0.5 + AIO 0.5 + LightX2V 4step。当たりは本線で焼き直し |
| レズビアンクンニ | 全裸の出会い→キス→クンニ | 解剖 0.5 + クンニ 0.55 + 穴の見え方 0.4 + Larry 0.5 |
| 性器を広げる | 広げて見せるクローズ | 解剖 0.5 + 広げる 0.5 + 穴の見え方 0.4 + Larry 0.5 |
| レズ＋広げる | クンニに広げるを足す | 解剖 0.5 + クンニ 0.55 + 広げる 0.45 + Larry 0.5。穴の見え方は外す |
...
**速さ:** 本線は Larry 8step。試し打ち・最速プレビューだけ LightX2V 4step。ワンショットは 4〜15（1本）。物語チェーンの各本は10秒。チェーンを15秒にするな。20〜120秒の「つなぐ」は同じカットを最後のコマで繋ぐ（10秒ずつ。1本で伸ばさない）。20秒は 10×2、120秒は 10×12。2〜12本目の文は③のつなぎ欄。空なら前の続き。「登校（専用）」などはカット割りで、つなぐとは別。「登校（つなぐ）」「登校（つなぐ修）」は同じ JSON を最後のコマで繋ぐ再生。
...
**アナル／飲尿／脱糞（どの構図）:** ThumbInButt は四つん這いに固定するので**アナルセックスには積まない**。竿＋穴＋文章だけ。立ち・騎乗・後背・横は文章欄に書く。手は腰。飲尿は亀頭先の黄色い水。脱糞は ThumbInButt を積む（積まないとマンコから出る）。今出している人間の糞（固形。ゼリーやスライムではない）。デフォルト以外の場所は③「脱糞（どの構図）」＋体位欄＋文章欄（カフェの便座、縁側、など）。物語ドロップダウンは選ばない。山小屋は扉の外の塗れ、ニクカベ肥溜めは最初から塗れている肥溜め。どちらも今出している動きではない。医院・終電の `No feces.` は外さない。既存話の飲尿はジュボのまま戻さない。指入れも ThumbInButt（四つん這い・穴が膣より上）。男・his は書かない。
...
- **参照土台（R2V / ref2va 約21GB）は既定オフ。** 短編集や参照つなぐの日だけオン。オフのまま「全部入れる」でも ref2va は入れない。FL2VA（Eros）・文字エンコーダ・VAE は今どおり
...
#@markdown **参照土台（R2V / ref2va 約21GB）も入れる**（短編集・参照つなぐの日だけ。普段はオフ）
参照土台も入れる = False  #@param {type:"boolean"}
...
from h3_lora_studio import (
    ...
    studio_engine_download_jobs, pick_studio_unet, want_r2v_engine, drop_ref2va_ids,
    find_ref2va_files,
)
...
need_r2v = want_r2v_engine(include_r2v=参照土台も入れる, scene=今使うシーン)
if not need_r2v:
    print("参照土台（R2V / ref2va・約21GB）は飛ばします。短編集や参照つなぐの日は「参照土台も入れる」をオン。")
...
if fast:
    ...
    if need_r2v and not find_ref2va_files(DRIVE_MODELS):
        _fetch_r2v()
else:
...
if fast and have_local and not need_r2v:
...
**専用の5パターン（同じ話・同じ JSON）:** `登校（専用）` ＝ カット（最後のコマから続けない）。`登校（つなぐ）` ＝ 文を直さず最後のコマから I2V（Picture 1 ロックだけ）。`登校（つなぐ修）` ＝ 最後のコマから I2V ＋ 1本目を長回しに直す。`登校（参照つなぐ）` ＝ 1本目 R2V。`登校（参照つなぐ修）` ＝ 参照つなぐ＋1本目を直す。初期値は物語＝登校／再生＝つなぐ。旧名 `登校120秒（専用）` も専用。アナルの三択（①②③）は汎用40秒で、帰宅や訪問販売の文は差し替えない。
...
- **①口内で終わる** … アナルの三択そのもの。汎用40秒。会話→根元ジュボ→口内 CUMOUF→口移し。体位欄は無視
- **②フェラのあとアナル** … アナルの三択そのもの。汎用40秒。ジュボで射精せず抜き→アナル挿入オンカメラ→アナル中出し。体位欄がアナル本に効く
- **③会って即アナル** … アナルの三択そのもの。汎用40秒。短いベロチューですぐ受け入れる姿勢→10-20でアナル挿入オンカメラ（まだ出さない）→20-30アナル中出し。体位欄がアナル本に効く
- **帰宅（専用 / つなぐ / つなぐ修）** … 10秒×12本。玄関ジュボは抜く。リビングでジュボのあと射精せず、後背位アナル中出し。口内 CUMOUF なし。セリフは口元の本だけ。写真は `input/homecoming-90s/` の 01〜12
- **洗い物（専用 / つなぐ / つなぐ修）** … 10秒×12本。サヤカはシンク固定。アヤは床でジュボのあと射精せず、後背位アナル中出し。口内 CUMOUF なし。写真は `input/dishes-90s/` の 01〜12
- **登校（専用 / つなぐ / つなぐ修）** … 第1話。朝〜大学正門。10秒×12本＝120秒。16:9。玄関ジュボは抜くだけ。路地でジュボのあと射精せず、立ち後背位アナル中出し。セリフは口元3本（いってらっしゃい／おくれるよ／ほしい）。授業は授業。**今の準備はテキストから。** `input/commute-120s/` の試験jpgは③がテキストからなら使わない。旧名「登校120秒（専用）」も専用
- **授業（専用 / つなぐ / つなぐ修）** … 第2話。授業〜昼。10秒×10本＝100秒。16:9。家とサヤカは出さない。ジュボのあと射精せず、個室で後背位アナル中出し。口内 CUMOUF なし。セリフは「まだひるだよ」だけ。セックスの続きは屋上。写真は `input/lecture-120s/` の 01〜10
- **屋上（専用 / つなぐ / つなぐ修）** … 第3話。屋上で立ち後背位アナル中出し〜家の門。10秒×10本＝100秒。16:9。AIOなし・hmmotionなし。歩く本にセックス部品なし。玄関はおかえり。サヤカなし。写真は `input/rooftop-100s/` の 01〜10
- **おかえり（専用 / つなぐ / つなぐ修）** … 第4話。家の門〜玄関ジュボのあと射精せず、立ち後背位アナル中出し。10秒×12本＝120秒。16:9。口内 CUMOUF なし。夜風呂は風呂。写真は `input/okaeri-120s/` の 01〜12
- **風呂（専用 / つなぐ / つなぐ修）** … 第5話。夜の風呂。洗い場でジュボのあと射精せず、座位アナル中出し。10秒×12本。口内 CUMOUF なし。ご飯〜食卓は食卓。写真は `input/bath-120s/` の 01〜12
- **食卓（専用 / つなぐ / つなぐ修）** … 第6話。テーブル下ジュボのあと射精せず、座位アナル中出し。10秒×12本。口内 CUMOUF なし。夜の布団は布団。写真は `input/dinner-120s/` の 01〜12
- **布団（専用 / つなぐ / つなぐ修）** … 第7話。横になったままジュボのあと射精せず、正常位アナル中出し。10秒×12本。口内 CUMOUF なし。休日午前は休日。写真は `input/futon-120s/` の 01〜12
- **休日（専用 / つなぐ / つなぐ修）** … 第8話。ソファは後輩騎乗位アナル中出し（アナル本では抜かない）→ハードカットで床ジュボ→口内＋口移し。アナル本に騎乗LoRAなし。AIOなし。午後の縁側は縁側。写真は `input/sunday-120s/` の 01〜12
- **縁側（専用 / つなぐ / つなぐ修）** … 第9話。後背位座位アナル中出し（抜かない）→ハードカットでアヤがマドカをジュボ→口内＋口移し。竿役はマドカ。レイは入れない。写真は `input/engawa-120s/` の 01〜12
- **訪問販売（専用 / つなぐ / つなぐ修）** … 名前付きパック。ミルク売り。帽子（ハット）のみ。販売員常時1人。こんにちは→アヤ不出→おじゃましまーす右へ。玄関仰向けM字アナニー。覆い被さりベロチュー→正常位膣挿入。パコ。膣中出し。抜きカエル。サービスおしっこ。8本＝80秒。16:9。口内 CUMOUF なし。hmmotion なし。正常位LoRA having missionary sex は c3-c5 に 0.4 まで。顔が消えたら外す。旧名「訪問販売60秒（つなぐ）」＝つなぐ修
- **定期検診（専用 / つなぐ / つなぐ修）** … 名前付きパック。家の玄関。ジュボのあと射精せず正常位アナル中出し。「ふふ、モンダイありすぎ。アナルにだされすぎ、、、」。口内 CUMOUF と口移しなし。9本＝90秒。16:9
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院。アヤ受け＋医師竿。こんにちは→椅子座りジュボ（顔残し）→10秒ずっとジュボ→口を外すご褒美小便→まみれベロチュー→30度四つん這い接触（outer ring of the anus entrance）→同じ姿勢で挿入オンカメラ→パコパコ→アナル中出し。c5-c9は黄色い小便まみれを落とさない。騎乗なし。女医は仰向けにしない。口内 CUMOUF と口移しなし。9本＝90秒。16:9
- **終点40秒（つなぐ）** … 名前付きパック。10秒×4本。起こしのあと跪いて咥える。ジュボで起きる。口内 CUMOUF のあと車掌に戻る（①のまま）
- **終電（専用 / つなぐ / つなぐ修）** … 名前付きパック。ジュボ20秒→車内口内＋口移しで起こす→ホームでキス／立ちジュボ→射精せず立ち後背位アナル中出し→抱擁。車内の口内だけ①のまま。ホームの口移しなし。10本＝100秒
- **ザーメン風呂（専用 / つなぐ / つなぐ修）** … 名前付きパック。5本＝50秒。白い粘液のおフロ。口移しなし。挿入なし。ジュボなし。三択の外
- **ニクカベ（専用 / つなぐ / つなぐ修）** … 名前付きパック。巨大生物の体内。歩行はうわぁ＋手繋ぎ＋軽いキス。ジュボのあと射精せず立ち後背位アナル中出し。口内 CUMOUF と口移しなし。7本＝70秒
- **ニクカベ肥溜め（専用 / つなぐ / つなぐ修）** … 名前付きパック。**今出している脱糞ではない**（最初から塗れている）。キス→ジュボ→射精せず四つん這いアナル中出し。口内なし。7本＝70秒
- **山小屋（専用 / つなぐ / つなぐ修）** … 建前パック。10秒×8本＝80秒。糞まみれで扉の外のアヤ一人（**今出している脱糞ではない。塗れ**）。便座でレイがシコシコ→ベロチュー→ジュボ→騎乗（マンコ）→後背→アナル中出しはアナルから溢れる。アナル本に騎乗LoRAなし
- **ハチコウ（専用 / つなぐ / つなぐ修）** … 物語の追加。夜の渋谷ハチコウ前。キス→口を開けて先端から手の幅→無言ジュボ口内＋口移し。10秒×2＝20秒。①のまま
...
- **脱糞（どの構図）** … 今、肛門から出している動き。人間の糞（ソーセージ状の固形。ゼリーやスライムではない）。ThumbInButt を積む（積まないとマンコから出る）。**デフォルト以外の場所は体位欄＋文章欄**（カフェの便座、縁側、など）。物語ドロップダウンは選ばない。山小屋／ニクカベ肥溜めは塗れであって出す行為ではない。医院・終電には足さない。アナルセックスには積まない
...
- **試し打ち** … ふたなり＋女。男なし
- **秒数** … ワンショットは 4〜15（1本）。物語チェーンの各本は10秒。チェーンを15秒にするな。つなぐ 20〜120秒は同じカットを最後のコマで繋ぐ（10秒ずつ）。専用120秒は上の「物語」＋「再生」で選ぶ（カット。ここは触らない）
- **レズビアンクンニ** … 女同士。男なし
- **性器を広げる** … 女1人。男なし
- **レズ＋広げる** … 女同士。男なし
"""
...
#@markdown ### まずここ（4欄）
#@markdown **シーン / 物語 / 再生 / ThumbInButt**。物語を選ぶと物語が勝つ。行為・三択・生成し直し・短編集は物語を「（シーンのまま）」にしてからシーン欄を選ぶ。初期値は登校＋つなぐ＋ThumbInButtなし。
...
#@markdown **フリー文の部品**（物語JSONでは無視。文章が空のときも無視）
フリー文の部品 = "シーンのまま"  #@param ["シーンのまま", "手で選ぶ", "Turboだけ"]
肌mystic = True  #@param {type:"boolean"}
竿 = True  #@param {type:"boolean"}
穴 = True  #@param {type:"boolean"}
フェラLoRA = False  #@param {type:"boolean"}
四つん這いandgs = False  #@param {type:"boolean"}
正常位LoRA = False  #@param {type:"boolean"}
TIB親指 = False  #@param {type:"boolean"}
#@markdown 写真からのときだけ。`auto` か空なら `input/phone` の一番新しい jpg。テキストからでは使いません。
写真ファイル = "auto"  #@param {type:"string"}
#@markdown 秒数。ワンショットは 4〜15。物語チェーンの各本は10秒。同じカットを長くするなら下の「つなぐ」。専用120秒では無視。
...
if callable(_ensure):
    _ensure(drive_root=_sel_drive, branch="cursor/h3-anal-stories-f112")
else:
    ...
    if not _sel.is_file():
        try:
            _req = urllib.request.Request(
                "https://raw.githubusercontent.com/fireworker011/Research/cursor/h3-anal-stories-f112/h3-lora-studio/scripts/select_loras.py",
            ...
            pass
    if (not _sel.is_file()) or "CONCEPT_LORA_ID" not in _sel.read_text(encoding="utf-8"):
...
if is_story(やりたいシーン) or is_chain_pack(やりたいシーン):
    ...
    KIND_JA = (
        "専用ストーリー"
        if is_story(やりたいシーン)
        else ("アナルの三択" if is_anal_pattern(やりたいシーン) else "名前付きパック（専用ストーリーではありません）")
    )
...
elif is_anal_pattern(やりたいシーン) and SITUATION != "anal-p1-oral":
    print("体位:", 体位 or "立ち", "（②③のアナル本に当てる）")
elif is_anal_pattern(やりたいシーン):
    print("体位: ①口内で終わるは体位欄を使いません。")
...
if is_anthology(やりたいシーン):
    ...
    if any(float(c.get("duration_s") or 0) > FL2VA_MAX_CLIP_S + 0.01 for c in STORY["clips"]):
        print("15秒超のワンショットは15秒にします（物語チェーンの各本は10秒のまま）")
    ...
    STORY = load_story(SITUATION, studio_root=STUDIO, pose=POSE, scene=文章)
    if REDO:
...
if STORY:
    ...
    if should_apply_freeform_lora_picks(文章, using_story=bool(STORY)):
        ...
        stack, missing_free = filter_freeform_lora_stack(
            stack, mode=フリー文の部品, picked_ids=picked,
        )
        for lid in missing_free:
            print(FREEFORM_MISSING_HINT + ":", lid)
        if TIB親指:
    ...
    if THUMB_IN_BUTT and generic_wants_thumbinbutt(SITUATION):
        ...
        cfg["stack"] = stack
        prompt = prepend_triggers(cfg["prompt"], stack)
    stack = apply_anal_any_stack(stack, situation=SITUATION, lora_dir=COMFY_DIR / "models" / "loras", prompt=prompt)
    ...
    print("積んだ id:")
    for x in stack:
        print(" -", x.get("id"), "強度", x.get("strength_model") if x.get("strength_model") is not None else x.get("strength"))
...
want_ref_weight = needs_ref2va_weight(
    play=再生,
    scene=やりたいシーン,
    redo_story=作り直しの物語 if REDO else "",
)
if need_r2v or str(MODE) == "r2v":
    want_ref_weight = True
if not 試し打ちだけ:
...
ref2va_files = find_ref2va_files(COMFY_DIR / "models")
if want_ref_weight and not ref2va_files and not 試し打ちだけ:
    drive_ref = require_ref2va_or_exit(
        local_models=COMFY_DIR / "models",
...
if not VANILLA:
    ...
    if STORY:
        ...
        if STORY.get("use_cast_ref") or str(STORY.get("kind") or "") == "anthology":
            for extra in ("minimax-h3-turbo-ref2v-4step", "aftermidnight-ref2va", "blowjob-h3"):
    ...
    stack = apply_anal_any_stack(stack, situation=SITUATION, lora_dir=lora_dir, prompt=prompt)
    prompt = prepend_triggers(prompt, stack)
    prompt = strip_thumb_in_butt_trigger(prompt)
    if replaced:
...
if 試し打ちだけ:
    ...
    for CLIP_INDEX, CLIP_DURATION in enumerate(CLIPS):
        if STORY and REDO and CLIP_INDEX < REDO_PLAN_IDX:
            ...
            try:
                planned_skip = prepare_story_clip(STORY, CLIP_INDEX, last_frame=None, stills_dir=STORY_STILLS, studio_root=STUDIO, catalog_path=STUDIO / "catalog" / "loras.json", forbidden_path=FORBIDDEN_FILE, prev_situation=prev_sit, prev_stack=prev_stack, force_t2v=FORCE_T2V, cast_dir=CAST_DIR, thumb_in_butt=THUMB_IN_BUTT, lora_dir=COMFY_DIR / "models" / "loras")
            except SystemExit as exc:
                hint = friendly_select_error(exc)
                raise SystemExit(hint or str(exc)) from None
...
assert '参照土台も入れる = False' in CELL2
assert "want_r2v_engine(include_r2v=参照土台も入れる" in CELL2
assert "drop_ref2va_ids(ids)" in CELL2
assert "R2V / ref2va・約21GB）は飛ばします" in CELL2
...
assert "filter_freeform_lora_stack(" in CELL3
