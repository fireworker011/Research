...
| 定期検診（専用 / つなぐ / つなぐ修） | 家の玄関。医師（32・結い髪・中乳・竿なし・聴診器）がレイ（20cm）を訪問検診。1本目は左手に医師が一人、チャイム＋こんにちは、右からレイ、短いフレンチキスとハグですぐ離れる。対面30秒。ベロチューとジュボは無言10秒。口パク後は肌。9本＝90秒。9:16 | 名前付きパック。こんにちは／はい→フレンチキスとハグですぐ離れる→テイキケンシン／ヨロシク→恍惚の軽いキス→かたくておっきい（軽くチンチンにキス）／シツレイしまーす→キスと胸→カクニン→口内→モンダイありますねのあと立ち上がって精液口移し。診察室ではない。台詞は話し言葉 |
...
FETCH_REV = "h3-20260911-checkup-kiss-1"
...
- **定期検診（専用 / つなぐ / つなぐ修）** … 名前付きパック。対面30秒。セリフは10秒、ベロチューとジュボは無言10秒。9本＝90秒。9:16。診察室ではない。家の玄関。1本目: 医師が画面左手・玄関扉の前に一人で立つ→チャイム＋「こんにちは」→右側の扉が開いてレイが「はい」→短いフレンチキスとハグですぐ離れる。10-20は「テイキケンシンにきました」「あ、ヨロシクオネガイします！」のあと恍惚の軽いキスですぐ離れる。20-30は「ふふ、オチンチンかたくておっきい！」と妖艶に微笑んで軽くチンチンにキス、「では、シツレイしまーす！」。そのあとキスは両手で胸＋腹に竿。口パク後の無言は肌が動く。カクニンは立ちの口パクのみ。口内は粘る白液を残して見せる。最後は「モンダイありますね」のあと立ち上がって精液口移し濃厚ディープキス。医師（32・結い髪・中乳・竿なし・聴診器）とレイ（20cm 立ち）。台詞は1本2行まで。台詞本はシネマを外す。音声は「」の日本語だけ
