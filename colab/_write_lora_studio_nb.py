...
| 定期検診（専用 / つなぐ / つなぐ修） | 家の玄関。医師がレイを訪問。対面→キス→ジュボ→射精せず正常位アナル中出し。「アナルにだされすぎ」。9本＝90秒。9:16 | 名前付きパック。口内 CUMOUF と口移しなし。診察室ではない。台詞は話し言葉 |
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤが来る。問診→ディープキス→しゃがみジュボ→押し倒しジュボ→射精せず騎乗アナル中出し→ゲンキ。10本＝100秒。9:16 | 名前付きパック。騎乗 LoRA なし。口内 CUMOUF と口移しなし。押し倒したあと女医はずっと仰向け |
...
- **定期検診（専用 / つなぐ / つなぐ修）** … 名前付きパック。家の玄関。ジュボのあと射精せず正常位アナル中出し。「ふふ、モンダイありすぎ。アナルにだされすぎ、、、」。口内 CUMOUF と口移しなし。9本＝90秒
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院。問診→ディープキス→しゃがみジュボ→押し倒しジュボ→射精せず騎乗アナル中出し→ゲンキ。騎乗 LoRA なし。口内 CUMOUF と口移しなし。10本＝100秒
