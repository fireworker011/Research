...
| ニクカベ（専用 / つなぐ / つなぐ修） | 肉壁の中。茶色い粘液で全身汚れ、白いおフロに入る。アヤ22ミニ・竿なし＋レイ24・20cm。顔は液面より上。7本＝85秒。9:16 | 名前付きパック。全部飲む。口移しなし。家のザーメン風呂とは別。hmmotion なし |
...
- **ニクカベ（専用 / つなぐ / つなぐ修）** … 名前付きパック。7本＝85秒。9:16。肉壁の中。茶色い粘液は壁から、白は風呂。混ざるが消えない。顔は液面より上。アヤ22ミニ・竿なし。レイ24・20cm。歩行15秒、台詞10秒、ジュボ15・口内15は無言。全部飲む。口移しなし。家のザーメン風呂とは別。台詞: あ、おフロ。。。でもこれって／ザーメンの、、、おフロ、、、すごいニオイ、、、／ザーメンのおフロ。。。あったかーい／もうガマンできない！おチンチンジュボジュボするの！／レイのザーメンおいしかった！
