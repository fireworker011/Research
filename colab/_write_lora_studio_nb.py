...
FETCH_REV = "h3-20260907-shorts-1"
...
- **終点40秒（つなぐ）** … 名前付きパック。10秒×4本。9:16。車掌（29・短髪・中乳・竿なし・ホイッスル）と座席で寝ているレイ（立たない）。「しゅうてんです、おきてください」では起きない。ジュボで起きる。口内 CUMOUF（無言）。「おきましたか？おきゃくさん、しゅうてんだからおりてください」で車掌に戻る
