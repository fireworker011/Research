...
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤが来る。医師（32・結い髪・中乳・聴診器・20cm玉なしマンコあり）。口はアヤ。前半テンポ良く。6本＝75秒。9:16 | 名前付きパック。呼び出し→ウンチ相談→おクチキス→ジュボ尻餅→口内→同じ目線で口移し→ゲンキ。台詞は話し言葉 |
...
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院にアヤが来る。6本＝75秒。9:16。医師（32・結い髪・中乳・聴診器・ふたなり20cm・玉なし・根元にマンコ）。口はアヤ22ミニ・竿なし。前半テンポ良く。台詞は10秒・2行まで（余るとH3が喋る）。無言キス15・ジュボ15・口内15。ゲンキは口パク10秒。口内のあとジュボ側が同じ目線に立ち上がって濃厚キス口移し。hmmotion なし。台詞: ツギのヒトどうぞー！／ヨロシクオネガイします！あ、オチンチンおっきい！／ちょっとサイキン、ウンチがでなくて。ミッカまえからです／タイヘンですね！じゃあまずおクチからみましょう！／ゲンキになりましたね／ありがとうございます
