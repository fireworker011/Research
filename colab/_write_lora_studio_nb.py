...
| ふたなりフェラ | 竿＋穴併用。相手はふたなりではない | フェラ 0.75 + 竿 0.7 + 穴の見え方 0.55 + Larry 0.5 / 8step |
| セックス（女体） | 挿入。男にはしない。相手の穴も出す | 総合えっち 0.8 + 竿 0.7 + 穴の見え方 0.55 / 12step |
| アナルセックス（女体） | アナル挿入。受け側のマンコとアナル | CoachBate + 竿 + 穴の見え方。無いときは総合えっち＋竿 |
| アナル舐め・指 | 舐め・指のアップ | 穴の見え方 0.7 + Larry 0.5 + シネマ 0.4 |
| フェラ | フェラ本線 | フェラ 0.75 + 竿 0.7 + Larry 0.7 |
| ふたなりフェラ | 竿＋穴併用。相手はふたなりではない | フェラ 0.75 + 竿 0.7 + 穴の見え方 0.55 + Larry 0.5 / 8step |
| セックス（女体） | 挿入。男にはしない。相手の穴も出す | 総合えっち 0.8 + 竿 0.7 + 穴の見え方 0.55 / 12step |
| アナルセックス（女体） | アナル挿入。受け側のマンコとアナル | CoachBate 0.85 + 竿 0.7 + 穴の見え方。Turbo なし |
...
**エロの重ね:** 行為1 + ヘルパー1 + Turbo1。ふたなりフェラはヘルパー2（竿＋穴）+ Larry 8step。シネマを足すならヘルパーを落とす。挿入ショットに Turbo は切る。Fal には載せない。
...
- **アナルセックス（女体）** … CoachBate + 竿 + 穴の見え方。Turbo なし。受け側のマンコとアナル。挿入側も女体。専用部品が無いときは総合えっち＋竿
- **アナル舐め・指** … 舐め、それから指
- **フェラ** … 正面から竿。`bl0w_j0b` と `PENISLORA` は自動
- **ふたなりフェラ** … フェラ + 竿 + 穴の見え方 + Larry 0.5 / 8step。ふたなり側は竿＋女陰＋肛門。相手はふたなりではなくマンコとアナルが見える。変身 LoRA は足さない
- **セックス（女体）** … 総合えっち + 竿 + 穴の見え方 / 12step。挿入が見える横クローズ。相手のマンコとアナル。男・筋肉質の男体にはしない
- **アナルセックス（女体）** … CoachBate + 竿 + 穴の見え方。Turbo なし。受け側のマンコとアナル。挿入側も女体
