...
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤが来る。医師（32・結い髪・中乳・聴診器・20cm玉なしマンコあり）。口はアヤ。パイプ椅子。1本目は左手でシコシコ無表情、右から入場、「おっきい」のあと短い立ちキス、右のパイプ椅子におすわり（女医は立つ）。10本＝100秒。9:16 | 名前付きパック。シコシコ→右入場→立ちキス→おすわり→立って胸を触りながらディープキス→オクスリ台詞→しゃがみジュボ（マンコこすり）→押し倒し騎乗→中出し抜く→お掃除→仰向け口移し→ゲンキ。台詞は話し言葉 |
...
FETCH_REV = "h3-20260909-clinic-meat-1"
...
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院にアヤが来る。10本＝100秒。9:16。医師（32・結い髪・中乳・聴診器・ふたなり20cm・玉なし・根元にマンコ）。口はアヤ22ミニ・竿なし。医師の椅子はパイプ椅子。1本目: 女医は画面左手・パイプ椅子でまた開いてシコシコ無表情。アヤは右から入る。「オチンチンおっきい」のあと短い立ちキス。それから笑顔で、画面右手のパイプ椅子にどうぞおすわりください。女医は立ったまま。口の確認は女医が立って胸を触りながらディープキス。オクスリ台詞のあとしゃがみジュボ（アヤはマンコをこすりながら）。ガマンできないで押し倒し、騎乗で挿入→中出し→抜く→お掃除ジュボ→仰向けのまま口移し→ゲンキ。押し倒したあと女医はずっと仰向け。台詞は10秒・2行まで（余るとH3が喋る）。hmmotion なし。台詞: ヨロシクオネガイします！あ、オチンチンおっきい！／どうぞおすわりください／クチとムネはモンダイないですね。じゃあツギはおチンチンでオクスリあげますね！／もう、ガマンできない！／ゲンキになりましたね／ありがとうございます
