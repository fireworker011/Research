...
| 訪問販売（専用 / つなぐ / つなぐ修） | 玄関のミルク売り。帽子（ハット）のみ。口はアヤ、竿は5人目の販売員。ハンバイ→扱き→ベロチュー→跪いてジュボ→射精せず立ち後背位アナル中出し。8本＝80秒。9:16 | 名前付きパック。口内 CUMOUF なし。hmmotion なし。旧名「訪問販売60秒（つなぐ）」＝つなぐ修 |
| 定期検診（専用 / つなぐ / つなぐ修） | 家の玄関。医師がレイを訪問。対面→キス→ジュボ→射精せず正常位アナル中出し。「アナルにだされすぎ」。9本＝90秒。16:9 | 名前付きパック。口内 CUMOUF と口移しなし。診察室ではない。台詞は話し言葉 |
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤ受け＋医師竿。こんにちは→椅子座りジュボ（顔残し）→起立キスなし→ゴホウビ＋yellow urine→おしっこ、あったかーい！ありがとー！→30度四つん這い・先端が outer ring of the anus entrance に接触（未挿入）→同じ姿勢で根元まで挿入→パコパコ→アナル中出し→抜いて垂れ→ゲンキ。9本＝90秒。16:9 | 名前付きパック。騎乗なし。女医は仰向けにしない。口内 CUMOUF と口移しなし。レイなし。c5-c9は yellow urine が残る。c5-c8は SAME DIRECTION・NO KISS。rim / 縁 禁止 |
...
| カフェ（専用 / つなぐ / つなぐ修） | 夏のカフェ。おミズ＝ジュボ、ミルク＝ジュボのあと射精せず立ち後背位アナル中出し。コーヒーは本物。10秒×10本。9:16 | 建前パック。口内 CUMOUF なし。最後はアナルあつくて、だされちゃった |
...
- **訪問販売（専用 / つなぐ / つなぐ修）** … 名前付きパック。ミルク売り。帽子（ハット）のみ。ミルクは持たない。ハンバイ→扱き→ベロチュー→跪いてジュボ→射精せず立ち後背位アナル中出し。8本＝80秒。口内 CUMOUF なし。hmmotion なし。旧名「訪問販売60秒（つなぐ）」＝つなぐ修
- **定期検診（専用 / つなぐ / つなぐ修）** … 名前付きパック。家の玄関。ジュボのあと射精せず正常位アナル中出し。「ふふ、モンダイありすぎ。アナルにだされすぎ、、、」。口内 CUMOUF と口移しなし。9本＝90秒。16:9
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院。アヤ受け＋医師竿。こんにちは→椅子座りジュボ（顔残し）→起立キスなし→ゴホウビ＋yellow urine→おしっこ、あったかーい！ありがとー！→30度四つん這い接触（outer ring of the anus entrance）→同じ姿勢で挿入オンカメラ→パコパコ→アナル中出し。c5-c9は yellow urine が残る。騎乗なし。女医は仰向けにしない。口内 CUMOUF と口移しなし。9本＝90秒。16:9
