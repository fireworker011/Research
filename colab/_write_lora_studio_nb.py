...
| 訪問販売（専用 / つなぐ / つなぐ修） | 玄関のミルク売り。キャップのみ。ミルクは持たない。口はアヤ、竿は5人目の販売員（25・短め黒髪・中乳・20cm・玉なし・根元にマンコ）。1本目は左手に販売員が一人、チャイム、右からアヤ。ハンバイのあと扱き。対面20秒。ジュボ10秒。8本＝80秒。9:16 | 名前付きパック。ハンバイ→扱き→カチカチのあと跪いて口を開けて先端から手の幅→ミルク＝ジュボ→口内。セリフは話し言葉。旧名「訪問販売60秒（つなぐ）」＝つなぐ修 |
...
FETCH_REV = "h3-20260911-sales-milk-1"
