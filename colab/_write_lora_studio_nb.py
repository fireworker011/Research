...
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤが来る。医師（32・結い髪・中乳・聴診器・20cm玉なしマンコあり）。口はアヤ。1本目は左手でシコシコ無表情、右から入場、右の椅子におすわり。6本＝75秒。9:16 | 名前付きパック。シコシコ→右入場→おすわり→ウンチ相談→おクチキス（身を胸につける。胸は揉まない）→ジュボ尻餅→口内→同じ目線で口移し→ゲンキ。台詞は話し言葉 |
...
FETCH_REV = "h3-20260908-kenshin-1"
...
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院にアヤが来る。6本＝75秒。9:16。医師（32・結い髪・中乳・聴診器・ふたなり20cm・玉なし・根元にマンコ）。口はアヤ22ミニ・竿なし。1本目: 女医は画面左手・また開いてシコシコ無表情。アヤは右から入る。入ったら笑顔で、画面右手の目の前の椅子にどうぞおすわりください。2本目以降は変えない。台詞は10秒・2行まで（余るとH3が喋る）。無言キス15は身を胸につける（胸は揉まない）・ジュボ15・口内15。ゲンキは口パク10秒。口内のあとジュボ側が同じ目線に立ち上がって濃厚キス口移し。hmmotion なし。台詞: ヨロシクオネガイします！あ、オチンチンおっきい！／どうぞおすわりください／ちょっとサイキン、ウンチがでなくて。ミッカまえからです／タイヘンですね！じゃあまずおクチからみましょう！／ゲンキになりましたね／ありがとうございます
