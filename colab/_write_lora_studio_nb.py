...
| ふたなりフェラ | フェラ本線。穴は文章欄で足す | フェラ 0.75 + 竿 0.7 + 穴の見え方 0.55 + Larry 0.5 / 8step |
...
FETCH_REV = "h2-20260905-futa-plain"
...
- **アナルセックス（女体）** … CoachBate + 竿 + 穴の見え方。Turbo なし。アナル挿入本線。マンコは文章欄で足す。挿入側も女体。専用部品が無いときは総合えっち＋竿
- **アナル舐め・指** … 舐め、それから指
- **フェラ** … 正面から竿。`bl0w_j0b` と `PENISLORA` は自動
- **ふたなりフェラ** … フェラ + 竿 + 穴の見え方 + Larry 0.5 / 8step。空欄はフェラ本線。マンコやアナルは文章欄で足す。変身 LoRA は足さない
