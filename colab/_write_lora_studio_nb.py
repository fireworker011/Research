...
| 訪問販売（専用 / つなぐ / つなぐ修） | 玄関の水売り。口はアヤ、竿は5人目の販売員（25・短め黒髪・中乳・20cm・玉なし・根元にマンコ）。対面20秒。ジュボ10秒。8本＝80秒。9:16 | 名前付きパック。対面→おミズ（放尿を飲む）→ジュボ→口内。セリフは話し言葉。旧名「訪問販売60秒（つなぐ）」＝つなぐ修 |
| 定期検診（専用 / つなぐ / つなぐ修） | 家の玄関。医師（32・結い髪・中乳・竿なし・聴診器）がレイ（20cm）を訪問検診。対面30秒。ベロチューとジュボは無言10秒。口パク後は肌。9本＝90秒。9:16 | 名前付きパック。対面→キスと胸→カクニン→口内。診察室ではない。台詞は話し言葉 |
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤが来る。医師（32・結い髪・中乳・聴診器・20cm玉なしマンコあり）。口はアヤ。1本目は左手でシコシコ無表情、右から入場、「おっきい」のあとお互い立って短いキス、右の椅子におすわり（女医は立つ）。6本＝60秒。9:16 | 名前付きパック。シコシコ→右入場→立ちキス→おすわり→ウンチ相談→立ちのおクチキス（身を胸につける。胸は揉まない）→ジュボ尻餅→口内→同じ目線で口移し→ゲンキ。台詞は話し言葉 |
...
| ニクカベ（専用 / つなぐ / つなぐ修） | 巨大生物の体内。コンクリートに肉を貼った部屋ではない。茶色い粘液で全身・顔・髪・チンチン・マンコ汚れ、白いおフロはベトベトで肌に付く。レイは1本目からフタナリ勃起。歩行の床は弾力。足は沈まない。アヤ22ミニ・竿なし＋レイ24・20cm。顔は液面より上。7本＝70秒。9:16 | 名前付きパック。全部飲む。口移しなし。家のザーメン風呂とは別。hmmotion なし |
...
| 車内販売（専用 / つなぐ / つなぐ修） | 電車の車内販売。客レイ（自分の20cmは使わない）、販売員（26・短め黒髪・中乳・20cm・ワゴン）。おチャ＝放尿、ミルクコーヒー＝ジュボと口内。10秒×8本。9:16 | 建前パック。台詞は話し言葉 |
...
- **訪問販売（専用 / つなぐ / つなぐ修）** … 名前付きパック（専用ではない）。対面20秒。跪き済みではやく。おミズ＝放尿を飲み干してからジュボ10秒。8本＝80秒。9:16。玄関の対面。口はアヤ22ミニ・竿なし。販売員は5人目（25・短め黒髪・中乳・ふたなり20cm・金玉なし・根元にマンコ）。口内は粘る白液を残して見せる。セリフ: こんにちは。おミズ、とどけにきました／おそいわよ／はやくおミズちょうだい／あー、しみる／ありがとうございました。旧名「訪問販売60秒（つなぐ）」＝つなぐ修
- **定期検診（専用 / つなぐ / つなぐ修）** … 名前付きパック。対面30秒。セリフは10秒、ベロチューとジュボは無言10秒。9本＝90秒。9:16。診察室ではない。家の玄関。医師（32・結い髪・中乳・竿なし・聴診器）とレイ（20cm 立ち）。キスは両手で胸＋腹に竿。口パク後の無言は肌が動く。カクニンは立ちの口パクのみ。口内は粘る白液を残して見せる。台詞: こんにちは。テイキケンシンにきました／あ…はい、ヨロシクオネガイします／では、シツレイします／クチとムネはモンダイないですね／では、つぎはおチンチンのカクニンをします／モンダイありますね。台詞本はシネマを外す。音声は「」の日本語だけ
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院にアヤが来る。6本＝60秒。9:16。医師（32・結い髪・中乳・聴診器・ふたなり20cm・玉なし・根元にマンコ）。口はアヤ22ミニ・竿なし。1本目: 女医は画面左手・また開いてシコシコ無表情。アヤは右から入る。「オチンチンおっきい」のあと女医が立ち上がり、お互い立ったまま短いキス。それから笑顔で、画面右手の目の前の椅子にどうぞおすわりください。女医は立ったまま。3本目のおクチキスもお互い立つ。台詞は10秒・2行まで（余るとH3が喋る）。無言キス10は身を胸につける（胸は揉まない）・ジュボ10・口内10。ゲンキは口パク10秒。口内のあとジュボ側が同じ目線に立ち上がって濃厚キス口移し。hmmotion なし。台詞: ヨロシクオネガイします！あ、オチンチンおっきい！／どうぞおすわりください／ちょっとサイキン、ウンチがでなくて。ミッカまえからです／タイヘンですね！じゃあまずおクチからみましょう！／ゲンキになりましたね／ありがとうございます
...
- **ニクカベ（専用 / つなぐ / つなぐ修）** … 名前付きパック。7本＝70秒。9:16。巨大生物の体内。コンクリートに肉を貼った部屋ではない。おフロは生体の窪み。歩行の床は弾力。足は沈まない。茶色い粘液は全身・顔・髪・チンチン・マンコ。白は風呂。水ではなくベトベトで肌に付く。混ざるが消えない。顔は液面より上。レイは1本目からフタナリ勃起20cm。竿は風呂から生えない。アヤ22ミニ・竿なし。レイ24・20cm。歩行10秒、台詞10秒、ジュボ10・口内10は無言。全部飲む。口移しなし。家のザーメン風呂とは別。台詞: あ、おフロ。。。でもこれって／ザーメンの、、、おフロ、、、すごいニオイ、、、／ザーメンのおフロ。。。あったかーい／もうガマンできない！おチンチンジュボジュボするの！／レイのザーメンおいしかった！
