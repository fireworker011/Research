...
| 定期検診（専用 / つなぐ / つなぐ修） | 家の玄関。医師（32・結い髪・中乳・竿なし・聴診器）がレイ（20cm）を訪問検診。対面30秒。ベロチューとジュボは無言15秒。口パク後は肌。9本＝100秒。9:16 | 名前付きパック。対面→キスと胸→カクニン→口内。診察室ではない。台詞はカタカナ |
