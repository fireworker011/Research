...
| 訪問販売（専用 / つなぐ / つなぐ修） | 玄関の水売り。口はアヤ、竿は5人目の販売員（25・短め黒髪・中乳・20cm・玉なし・根元にマンコ）。10秒×6本。9:16 | 名前付きパック。専用ではない。セリフは口元4本（カタカナ）。5〜6本目はフェラ（放尿→根元）。旧名「訪問販売60秒（つなぐ）」＝つなぐ修 |
...
FETCH_REV = "h3-20260907-futa-pussy-1"
