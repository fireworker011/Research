...
PORT = 8188
BRANCH = "cursor/h3-real-shaft-f112"
FETCH_REV = "h3-20260911-real-shaft-1"
...
if callable(_ensure):
    _ensure(drive_root=_sel_drive, branch="cursor/h3-real-shaft-f112")
else:
    ...
    if not _sel.is_file():
        try:
            _req = urllib.request.Request(
                "https://raw.githubusercontent.com/fireworker011/Research/cursor/h3-real-shaft-f112/h3-lora-studio/scripts/select_loras.py",
