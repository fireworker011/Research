...
| ケンシン（専用 / つなぐ / つなぐ修） | 医院。アヤ受け＋医師竿。こんにちは→即しゃがみジュボ→ジュボやめ+涎+起立ベロチュー→抱擁コシコシ→ごめんなさい／ダイジョウブですよー→四つん這い先端接触（未挿入）→挿入オンカメラ→パコパコ→アナル中出し→抜いて垂れ→ゲンキ。9本＝90秒。16:9 | 名前付きパック。騎乗なし。女医は仰向けにしない。口内 CUMOUF と口移しなし。レイなし |
...
- **ケンシン（専用 / つなぐ / つなぐ修）** … 名前付きパック。医院。アヤ受け＋医師竿。こんにちは→即しゃがみジュボ→起立ベロチュー→四つん這い接触→挿入オンカメラ→パコパコ→アナル中出し。騎乗なし。女医は仰向けにしない。口内 CUMOUF と口移しなし。9本＝90秒。16:9
