...
| 訪問販売（専用 / つなぐ / つなぐ修） | 玄関の水売り。口はアヤ、竿は5人目の販売員（25・短め黒髪・中乳・20cm・玉なし・根元にマンコ）。10秒×9本＝90秒。9:16 | 名前付きパック。対面→おミズ（放尿を飲む）→ジュボ→口内。セリフはカタカナ。旧名「訪問販売60秒（つなぐ）」＝つなぐ修 |
| 定期検診（専用 / つなぐ / つなぐ修） | 家の玄関。医師（32・結い髪・中乳・竿なし・聴診器）がレイ（20cm）を訪問検診。セリフ10秒、ベロチューとジュボは無言15秒。11本＝120秒。9:16 | 名前付きパック。対面→キスと胸→カクニン→口内。診察室ではない。台詞はカタカナ |
...
- **訪問販売（専用 / つなぐ / つなぐ修）** … 名前付きパック（専用ではない）。元の15秒×4を10秒×9本＝90秒。9:16。玄関の対面。口はアヤ22ミニ・竿なし。販売員は5人目（25・短め黒髪・中乳・ふたなり20cm・金玉なし・根元にマンコ）。おミズ＝放尿を飲み干してからジュボ。口内は粘る白液を残して見せる。セリフ: こんにちは。おミズをおトドケにきました／オソいわよ／モウシワケございません／ハヤクおミズちょうだい／あー、シミる／ありがとうございました。旧名「訪問販売60秒（つなぐ）」＝つなぐ修
- **定期検診（専用 / つなぐ / つなぐ修）** … 名前付きパック。セリフは10秒、ベロチューとジュボは無言15秒。11本＝120秒。9:16。診察室ではない。家の玄関で対面したあと、その場で進める。医師（32・結い髪・中乳・竿なし・聴診器）とレイ（20cm 立ち）。キスは両手で胸。カクニンの2文は口パクを分け、ジュボは無言。口内は粘る白液を残して見せる。台詞: こんにちは／はーい／テイキケンシンにきました／あ…はい、ヨロシクオネガイします／では、シツレイします／クチとムネはモンダイないですね／では、つぎはおチンチンのカクニンをします／モンダイありますね。台詞本はシネマを外す。音声は「」の日本語だけ。プロンプトは読まない
