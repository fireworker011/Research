...
| ニクカベ（専用 / つなぐ / つなぐ修） | 巨大生物の体内。コンクリートに肉を貼った部屋ではない。茶色い粘液で全身・顔・髪・チンチン・マンコ汚れ、白いおフロはベトベトで肌に付く。レイは毎本フタナリ勃起。歩行の床は弾力。足は沈まない。アヤ22ミニ・竿なし＋レイ24・20cm。顔は液面より上。7本＝70秒。9:16 | 名前付きパック。口内のあとアヤが立ち上がって口移し。家のザーメン風呂とは別。hmmotion なし |
...
FETCH_REV = "h3-20260909-visit-door-1"
