...
| ふたなりフェラ | フェラ＋穴見え。AIO なし。女体のみ | フェラ 0.75 + 穴の見え方 0.55 + Larry 0.5 |
| セックス（女体） | 挿入。男にはしない | 総合えっち 0.8 + 竿 0.7 + Larry 0.5 / 12step |
...
- **ふたなりフェラ** … フェラ + 穴の見え方。性器と肛門が見える。竿 LoRA は枠のため外す。`PENISLORA` は文に残す。女体のみ
- **セックス（女体）** … 総合えっち + 竿 + Larry 12step。挿入が見える横クローズ。男・筋肉質の男体にはしない
