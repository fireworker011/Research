...
| 訪問販売（専用 / つなぐ / つなぐ修） | 玄関のミルク売り。キャップのみ。口はアヤ、竿は5人目の販売員。ハンバイ→扱き→ベロチュー→跪いてジュボ→射精せず立ち後背位アナル中出し。8本＝80秒。9:16 | 名前付きパック。口内 CUMOUF なし。hmmotion なし。旧名「訪問販売60秒（つなぐ）」＝つなぐ修 |
...
- **訪問販売（専用 / つなぐ / つなぐ修）** … 名前付きパック。ミルク売り。ハンバイ→扱き→ベロチュー→跪いてジュボ→射精せず立ち後背位アナル中出し。8本＝80秒。口内 CUMOUF なし。hmmotion なし。旧名「訪問販売60秒（つなぐ）」＝つなぐ修
