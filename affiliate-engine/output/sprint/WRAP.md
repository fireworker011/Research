...
書いた日: 2026-08-28 08:40 JST。CW 再読: 2026-08-28 09:57 JST。Cursor は発出しない。採否は指令塔。
...
- 公開 N は **6**。新規4に `fireworker12` なし（09:57 JST 公開再読）
- 4枚目は 13406725（短尺素材支給）。合わなければ同型 13408073。13407700 は通常尺なので4の代替にしない
