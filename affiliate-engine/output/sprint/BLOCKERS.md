...
- Secret 鍵名の確認は人間が GitHub UI で [overlay_status](https://github.com/fireworker011/Research/actions/workflows/affiliate_engine_overlay_status.yml) を Run workflow（ref デフォルト。投稿しない。schedule なし。この参謀ランから dispatch は 403。2026-08-28 15:00 JST の run list は空。今夜の1手ではない）
