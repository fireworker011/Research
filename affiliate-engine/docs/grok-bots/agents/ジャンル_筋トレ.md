...
`affiliate-engine/docs/grok-bots/agents/bodymake.md`
...
`affiliate-engine/docs/grok-bots/ledger/bodymake.md`

https://raw.githubusercontent.com/fireworker011/Research/cursor/video-channel-playbook-e013/affiliate-engine/docs/grok-bots/ledger/bodymake.md
...
| 0.5–4.7 | 本文 | 体は台所で作る、という整理の人が / います。週2×30分のトレより、 |
| 4.7–8.9 | 本文 | コンビニでタンパク質を足すかの方 / が先、という観察です。宅食は選択 |
| 8.9–13.1 | 本文 | 肢の一つ。比較の観点はプロフィー / ルへ。 |
...
|---|---|---|
| 0.0–0.5 | 文字なし・映像のみ | （なし） |
| 0.5–4.7 | 本文 | サプリはトレーニングのお供、以上 / のことは言いません。筋肉がつく、 |
| 4.7–8.9 | 本文 | とは断定しません。先に週2が続く / か。中身の読み方はプロフィールに |
| 8.9–13.1 | 本文 | 置いてあります。 |
| 13.1–15.1 | CTA | 詳しくはプロフィールのリンク（PR） |
