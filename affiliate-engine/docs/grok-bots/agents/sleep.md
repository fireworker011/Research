...
`affiliate-engine/docs/grok-bots/agents/sleep.md`
...
`affiliate-engine/docs/grok-bots/ledger/sleep.md`

https://raw.githubusercontent.com/fireworker011/Research/cursor/video-channel-playbook-e013/affiliate-engine/docs/grok-bots/ledger/sleep.md
...
| 0.5–4.7 | 本文 | 眠れない、の切り分けはカフェイン / ・光・温度・リズムのどれか、とい |
| 4.7–8.9 | 本文 | う整理があります。全部やらなくて / いい。1つだけ。感じ方には個人差 |
| 8.9–13.1 | 本文 | があります。 |
...
|---|---|---|
| 0.0–0.5 | 文字なし・映像のみ | （なし） |
| 0.5–4.7 | 本文 | マットレス、硬さの好みは分かれる / ので断定しません。見る点は厚さ・ |
| 4.7–8.9 | 本文 | 試し寝できるか・返品の条件。買っ / た話はしません。観点だけプロフィ |
| 8.9–13.1 | 本文 | ールへ。 |
| 13.1–15.1 | CTA | 詳しくはプロフィールのリンク（PR） |
...
|---|---|---|
| 0.0–0.5 | 文字なし・映像のみ | （なし） |
| 0.5–4.7 | 本文 | リカバリー系の衣類、温かい／締め / つけ、の感想は個人差が大きいです |
| 4.7–8.9 | 本文 | 。効く、とは言いません。素材とサ / イズの見方だけプロフィールにまと |
| 8.9–13.1 | 本文 | めています。 |
| 13.1–15.1 | CTA | 詳しくはプロフィールのリンク（PR） |
