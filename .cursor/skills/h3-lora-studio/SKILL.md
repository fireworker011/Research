...
エロ: 行為1 + ヘルパー0〜1 + Turbo0〜1。ふたなりフェラはヘルパー2（竿＋穴）+ Larry 0.5 / 6step。セックス（女体）/ アナルはヘルパー2で Turbo オフ。CoachBate アナルは Turbo オフ・16step。汎用エロ / 騎乗は AIO + Larry 0.5 / 12step（LightX2V にはしない）。セックス（女体）は竿 0.7 + 穴の見え方 0.55。変身 LoRA は足さない。穴の見え方 LoRA は積むが、空欄文は行為本線だけ。マンコ/アナルの強調は③の文章欄。空欄文は挿入・リズム・横クローズを書く。秒数は 1本 4〜15。16〜60秒は最後のコマつなぎ。60秒は 10×6。2〜6本目は③のつなぎ欄（空なら前の続き）。挿入 LoRA と SFW の速い＋綺麗は併用しない。セックス（女体）/ アナルセックス（女体）は男・筋肉質の男体にしない。
