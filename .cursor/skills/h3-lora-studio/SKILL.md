...
エロ: 行為1 + ヘルパー0〜2 + Turbo0〜1。ふたなりフェラはヘルパー2（竿＋穴）+ Larry 0.5 / 6step。セックス（女体）/ アナル / 騎乗 / 後背位はヘルパー2で Turbo オフ。CoachBate アナルは Turbo オフ・16step。体位 LoRA は AIO の代わり（同時に積まない）。騎乗は cowgirl + 竿 + 穴 / 12step。後背位は doggy + 竿 + 穴 / 12step。正常位POVは POV + 竿 + Larry 0.5 / 8step（横はセックス（女体））。後射精は HMCumshot + 竿 + Larry 0.5 / 8step。指入れとオナニーは別シーン（同時に積まない）。足コキは Type D + 竿 + Larry。絶頂は Remoteorgasm（射精ではない）。汎用エロは AIO + Larry 0.5 / 12step。変身 LoRA は足さない。riding-pose-i2v は I2V専用で未使用。穴の見え方 LoRA は積むが、空欄文は行為本線だけ。マンコ/アナルの強調は③の文章欄。秒数は 1本 4〜15。16〜60秒は最後のコマつなぎ。60秒は 10×6。2〜6本目は③のつなぎ欄（空なら前の続き）。挿入 LoRA と SFW の速い＋綺麗は併用しない。セックス（女体）/ アナルセックス（女体）/ 体位シーンは男・筋肉質の男体にしない。訓練で体位を足さない。
