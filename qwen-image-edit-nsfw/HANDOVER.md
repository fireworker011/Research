...
HEAD: 05904ba h3: Qwen Edit のアナルは尻の穴、脱糞は尻カメラの固形
...
アナルやセックスで画風が実写になるのは、Space のクイック文が input photo / phone-camera だから。③はそれを image に直し、画風ロックを顔の直後と末尾に置く。画風欄は **入力のまま**（変換しない）。「リアル」は体液の質感用に選ぶときだけ。
