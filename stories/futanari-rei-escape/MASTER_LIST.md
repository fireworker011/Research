...
固定順。合間オナニーは「しない」ならその番号をスキップ。

| # | file | 内容 |
|---|---|---|
| S00 | S00_title.md | タイトル。レイなし |
...
| S13-A | branches/S13-A_human_mouth.md | 上の口。唇と舌の軌道 |
| S13-B | branches/S13-B_tail_second_mouth.md | 尾端第二口＋蠕動（優先） |
| S13-B FB | branches/S13-B_FALLBACK_tail_genital_orifice.md | 第二口が潰れたときだけ |
| S14 | S14_fade_run_D.md | 蛾女フェード→走りD |
| S15 | S15_optional_masturbate.md | 任意おな（汚れあり） |
| S16 | S16_succubus_encounter.md | サキュバス。画像4。全裸 |
...
| S24 | S24_escape.md | MISSION COMPLETE。洗わない |
...
S09 toilet T-a / T-b / T-c
S10 run C with filth
S11 optional masturbate with filth
S12 moth-girl encounter
S13-A human-mouth motion  OR  S13-B tail second-mouth peristalsis (fallback: tail-tip genital orifice, still insect)
S14 fade + run D
S15 optional masturbate
S16 succubus encounter
S17 who attacks
S18 kiss optional
S19 mouth optional (lip/tongue path, not label-only)
S20 position branch
S21 creampie orgasm
S22 succubus fade
S23 run E to exit
S24 escape / MISSION COMPLETE
