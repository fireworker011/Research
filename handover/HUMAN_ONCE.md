...
2. Grok **管理者**（`b6bf30a6-a4f5-41ca-a2db-b417d936b9f4`）に `dump/G_hq_admin.txt` を **一度**入れる。日常 clone に `HQ_100MAN.md` を一度。毎日 dump を貼り直すな。指示役の Run は不要（デフォルトへマージで初回、以後 07:22 JST）
