"""
動画㊲「うちの子クイズ、正解できますか」ナレーション音声生成（Voicevox / 波音リツ）

■ テンプレート脱却の実験動画・第4弾（視聴者参加型クイズ形式・CTAなし）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet37.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet37\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet37")
...
def main():
    print("=" * 50)
    print("動画㊲ ナレーション生成（波音リツ / クイズ番組風）")
    print(f"※{len(NARRATION)}シーン構成・CTAなし・視聴者参加型")
    print("=" * 50)
