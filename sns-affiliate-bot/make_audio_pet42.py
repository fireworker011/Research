"""
動画㊷「新しいおもちゃ、3秒で飽きられました」ナレーション音声生成（Voicevox / 波音リツ）

■ 猫のみ路線・確定方針適用（軽快な共感トーン・CTAなし）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet42.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet42\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet42")
