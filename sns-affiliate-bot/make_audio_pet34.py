"""
動画㉞「今日の寝相、こうだった」ナレーション音声生成（Voicevox / 波音リツ）

■ テンプレート脱却の実験動画（5シーン・CTAなし）
  従来の感動系より軽快なトーンにするため、SPEED を上げ INTONATION を抑えている。

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet34.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet34\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet34")
VOICEVOX   = "http://localhost:50021"
SPEAKER_ID = 9
# 感動系(0.88/1.4)ではなく、軽快なテンポに変更
SPEED      = 0.98
PITCH      = 0.0
INTONATION = 1.1
