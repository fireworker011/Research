"""
動画㉔「留守番中、猫の行動の7割は飼い主が知らない」ナレーション音声生成（Voicevox / 波音リツ）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet24.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet24\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet24")
