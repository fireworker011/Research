"""
動画㊶「お昼休み、こっそり様子を見てしまう」ナレーション音声生成（Voicevox / 波音リツ）

■ 女性キャラクター復帰・第2弾（平日編・5シーン・CTA軽く1回のみ）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet41.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet41\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet41")
...
def main():
    print("=" * 50)
    print("動画㊶ ナレーション生成（波音リツ / 平日編）")
    print(f"※{len(NARRATION)}シーン構成・CTA軽く1回のみ")
    print("=" * 50)
