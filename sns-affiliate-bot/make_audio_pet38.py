"""
動画㊳「うちの子、実は掃除機が苦手です」ナレーション音声生成（Voicevox / 波音リツ）

■ テンプレート脱却の実験動画・第5弾（あるある共感型・CTAなし）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet38.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet38\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet38")
