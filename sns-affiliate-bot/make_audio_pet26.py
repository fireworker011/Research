"""
動画㉖「休日、寝坊した朝に鳴った」ナレーション音声生成（Voicevox / 波音リツ）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet26.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet26\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet26")
