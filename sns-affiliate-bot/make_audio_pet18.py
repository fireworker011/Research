"""
動画⑱「留守番が得意な猫なんて、いない」ナレーション音声生成（Voicevox / 波音リツ）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet18.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet18\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet18")
