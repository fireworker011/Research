"""
動画㉟「今日のイタズラ、証拠を残していった」ナレーション音声生成（Voicevox / 波音リツ）

■ テンプレート脱却の実験動画・第2弾（5シーン・CTAなし・軽快トーン）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet35.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet35\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet35")
