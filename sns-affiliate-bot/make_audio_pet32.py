"""
動画㉜「ごはんより、待つ方が好きだった」ナレーション音声生成（Voicevox / 波音リツ）

新フォーマット: 猫目線モノローグ×食テーマ

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet32.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet32\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet32")
