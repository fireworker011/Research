"""
動画㊴「箱、届きました」ナレーション音声生成（Voicevox / 波音リツ）

■ テンプレート脱却の実験動画・第6弾（定点観測形式・CTAなし）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet39.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet39\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet39")
...
def main():
    print("=" * 50)
    print("動画㊴ ナレーション生成（波音リツ / 軽快な観察トーン）")
