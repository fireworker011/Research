"""
動画㉓「電車の中で、通知が鳴った」ナレーション音声生成（Voicevox / 波音リツ）

事前準備: Voicevox を起動（http://localhost:50021）

使い方:
  python make_audio_pet23.py

出力先: C:\\Users\\ys734\\Desktop\\audio_pet23\\
"""
...
OUTPUT_DIR = Path(r"C:\Users\ys734\Desktop\audio_pet23")
